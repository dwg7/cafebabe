...
**追記(2026-09-13)**: 上記3基準は「当該PRIVATEプロジェクト自身についての情報」を
対象にしていたが、プロジェクトに関わる**第三者**についての情報も同じ配慮の対象になる。
技術構成レベルの一言要約のつもりで書いた内容であっても、本人の同意が無いまま第三者を
特定しうる情報の伝播になりうる。**基準1「書いてよいもの」は、プロジェクト自身だけでなく、
そこに関わる第三者についても同じ基準(同意の無い識別情報は書かない)を適用すると
読み替える。**
